  ...
  document.querySelector("#logout").addEventListener("click", () => {
    ...
    if (origin.includes("localhost")) {
      if (pathArray.includes("src")) {
        xhr.open("GET", origin + "/static_logistics/src/php/config/clear_session.php", true); // Replace "clear_session.php" with the actual path to your PHP script
      } else {
        xhr.open("GET", origin + "/static_logistics/php/config/clear_session.php", true); // Replace "clear_session.php" with the actual path to your PHP script
      }
    }else{
